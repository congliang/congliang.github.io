---
title: 常见CMS漏洞挖掘思路
date: 2025-05-26 04:22:43
tags:
  - 代码审计
  - 框架安全
  - 渗透测试
categories: 渗透测试
description: 常见 CMS 漏洞挖掘——ThinkCMF/Discuz/DedeCMS/PHPCMS 后台 Getshell 通用技巧与插件/模板漏洞审计方法。
---
...
description: 常见 CMS 漏洞挖掘——ThinkCMF/Discuz/DedeCMS/PHPCMS 后台 Getshell 通用技巧。
```php
// 典型入口结构
